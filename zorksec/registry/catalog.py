...
_BLUE: list[ToolDef] = [
    ...
    _t("sherlock", "Sherlock", "Hunt down social-media accounts by username.",
       "OSINT for SOC", "both", "Checks hundreds of sites for a given username.",
       "apt", "sherlock", "sherlock --help", "https://github.com/sherlock-project/sherlock",
       "MIT", "sherlock", "sherlock-project/sherlock"),
    _t("maigret", "Maigret", "Collect a dossier on a person by username.",
       "OSINT for SOC", "both", "Finds accounts and profile details across many sites by username.",
       "pip", "maigret", "maigret --help", "https://github.com/soxoj/maigret",
       "MIT", "maigret", "soxoj/maigret"),
    _t("recon-ng", "Recon-ng", "Full-featured web reconnaissance framework.",
       "OSINT for SOC", "both", "A modular framework for organised OSINT collection.",
       "apt", "recon-ng", "recon-ng -h", "https://github.com/lanmaster53/recon-ng",
       "GPL-3.0", "recon-ng", "lanmaster53/recon-ng"),
    _t("holehe", "holehe", "Check if an email is used on different sites.",
       "OSINT for SOC", "both", "Tells you where an email address has registered accounts.",
       "pip", "holehe", "holehe --help", "https://github.com/megadose/holehe",
       "GPL-3.0", "holehe", "megadose/holehe"),
    _t("metagoofil", "Metagoofil", "Extract metadata from public documents.",
       "OSINT for SOC", "both", "Harvests usernames/software from a target's public documents.",
       "apt", "metagoofil", "metagoofil -h", "https://github.com/laramies/metagoofil",
       "GPL-2.0", "metagoofil", "laramies/metagoofil"),
...
_RED: list[ToolDef] = [
    ...
    _t("dnsrecon", "DNSRecon", "DNS enumeration and reconnaissance tool.",
       "Information Gathering", "both", "Pulls DNS records, zone transfers, and subdomains for a domain.",
       "apt", "dnsrecon", "dnsrecon -h", "https://github.com/darkoperator/dnsrecon",
       "GPL-2.0", "dnsrecon", "darkoperator/dnsrecon"),
    _t("dnsenum", "dnsenum", "Multithreaded DNS enumeration script.",
       "Information Gathering", "both", "Gathers DNS info and tries zone transfers and brute force.",
       "apt", "dnsenum", "dnsenum --help", "https://github.com/fwaeytens/dnsenum",
       "GPL-2.0", "dnsenum", "fwaeytens/dnsenum"),
    _t("fierce", "Fierce", "DNS reconnaissance and subdomain locator.",
       "Information Gathering", "both", "Locates non-contiguous IP space and hostnames for a domain.",
       "apt", "fierce", "fierce -h", "https://github.com/mschwager/fierce",
       "GPL-3.0", "fierce", "mschwager/fierce"),
    _t("whois", "WHOIS", "Look up domain/IP registration ownership records.",
       "Information Gathering", "both", "Shows who registered a domain or owns an IP block.",
       "apt", "whois", "whois example.com", "https://www.iana.org/whois",
       "GPL-2.0", "whois"),
    _t("dig", "dig (dnsutils)", "Query DNS servers for records of any type.",
       "Information Gathering", "both", "The go-to command for looking up A/MX/TXT/NS DNS records.",
       "apt", "dnsutils", "dig example.com", "https://www.isc.org/bind/",
       "MPL-2.0", "dig"),
    _t("host", "host (dnsutils)", "Simple DNS lookup utility.",
       "Information Gathering", "both", "A quick way to resolve a hostname to its IP and records.",
       "apt", "dnsutils", "host example.com", "https://www.isc.org/bind/",
       "MPL-2.0", "host"),
    _t("whatweb", "WhatWeb", "Identify technologies running on a website.",
       "Information Gathering", "both", "Fingerprints a site's CMS, server, and frameworks.",
       "apt", "whatweb", "whatweb --version", "https://github.com/urbanadventurer/WhatWeb",
       "GPL-2.0", "whatweb", "urbanadventurer/WhatWeb"),
    _t("wafw00f", "wafw00f", "Detect and fingerprint Web Application Firewalls.",
       "Information Gathering", "both", "Tells you if a website is protected by a WAF, and which one.",
       "apt", "wafw00f", "wafw00f -h", "https://github.com/EnableSecurity/wafw00f",
       "BSD-3-Clause", "wafw00f", "EnableSecurity/wafw00f"),
    _t("sublist3r", "Sublist3r", "Fast subdomain enumeration using search engines.",
       "Information Gathering", "both", "Finds subdomains of a site using public search engines.",
       "apt", "sublist3r", "sublist3r -h", "https://github.com/aboul3la/Sublist3r",
       "GPL-2.0", "sublist3r", "aboul3la/Sublist3r"),
    _t("assetfinder", "assetfinder", "Find domains and subdomains related to a target.",
       "Information Gathering", "red", "Quickly lists related domains/subdomains for a target.",
       "go", "github.com/tomnomnom/assetfinder@latest", "assetfinder --help",
       "https://github.com/tomnomnom/assetfinder", "MIT", "assetfinder", "tomnomnom/assetfinder"),
    _t("waybackurls", "waybackurls", "Fetch known URLs from the Wayback Machine.",
       "Information Gathering", "red", "Pulls historical URLs for a domain from web archives.",
       "go", "github.com/tomnomnom/waybackurls@latest", "waybackurls -h",
       "https://github.com/tomnomnom/waybackurls", "MIT", "waybackurls", "tomnomnom/waybackurls"),
    _t("dmitry", "DMitry", "Deepmagic information gathering tool.",
       "Information Gathering", "both", "Collects whois, subdomains, emails, and open ports for a host.",
       "apt", "dmitry", "dmitry -h", "https://www.kali.org/tools/dmitry/",
       "GPL-3.0", "dmitry"),
